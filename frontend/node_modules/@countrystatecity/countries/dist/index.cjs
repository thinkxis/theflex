  ...
  try {
    ...
    try {
      ...
      if (typeof __dirname !== "undefined") {
        ...
        basePath = pathModule.dirname(fileURLToPath((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('index.cjs', document.baseURI).href))));
      }
...
exports.getAllCitiesInWorld = getAllCitiesInWorld;
exports.getAllCitiesOfCountry = getAllCitiesOfCountry;
...
exports.getTimezoneForCity = getTimezoneForCity;
exports.isValidCountryCode = isValidCountryCode;
exports.isValidStateCode = isValidStateCode;
exports.searchCitiesByName = searchCitiesByName;
